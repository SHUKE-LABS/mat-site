...
// checkout, mirrored from shukelabs.com's src/config/pricing.ts so the two
// surfaces cannot drift. Pages render from these constants so prices, device
// caps, and links stay in step.
